...
npm run build -- ttf::IosevkaEtoile
...
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaEtoile/TTF/*.ttf -t %{buildroot}%{_datadir}/fonts/iosevka-etoile-fonts
