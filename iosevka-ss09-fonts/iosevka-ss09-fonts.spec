...
npm run build -- ttf::IosevkaSS09
npm run build -- ttf::IosevkaTermSS09
npm run build -- ttf::IosevkaFixedSS09
...
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaSS09/TTF/*.ttf      -t %{buildroot}%{_datadir}/fonts/iosevka-ss09-fonts
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaTermSS09/TTF/*.ttf  -t %{buildroot}%{_datadir}/fonts/iosevka-term-ss09-fonts
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaFixedSS09/TTF/*.ttf -t %{buildroot}%{_datadir}/fonts/iosevka-fixed-ss09-fonts
