...
npm run build -- ttf::IosevkaSS02
npm run build -- ttf::IosevkaTermSS02
npm run build -- ttf::IosevkaFixedSS02
...
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaSS02/TTF/*.ttf      -t %{buildroot}%{_datadir}/fonts/iosevka-ss02-fonts
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaTermSS02/TTF/*.ttf  -t %{buildroot}%{_datadir}/fonts/iosevka-term-ss02-fonts
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaFixedSS02/TTF/*.ttf -t %{buildroot}%{_datadir}/fonts/iosevka-fixed-ss02-fonts
