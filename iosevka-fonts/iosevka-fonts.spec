...
npm run build -- ttf::IosevkaTerm
npm run build -- ttf::IosevkaFixed
...
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaTerm/TTF/*.ttf  -t %{buildroot}%{_datadir}/fonts/iosevka-term-fonts
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaFixed/TTF/*.ttf -t %{buildroot}%{_datadir}/fonts/iosevka-fixed-fonts
