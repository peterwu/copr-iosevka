...
npm run build -- ttf::IosevkaSS18
npm run build -- ttf::IosevkaTermSS18
npm run build -- ttf::IosevkaFixedSS18
...
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaSS18/TTF/*.ttf      -t %{buildroot}%{_datadir}/fonts/iosevka-ss18-fonts
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaTermSS18/TTF/*.ttf  -t %{buildroot}%{_datadir}/fonts/iosevka-term-ss18-fonts
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaFixedSS18/TTF/*.ttf -t %{buildroot}%{_datadir}/fonts/iosevka-fixed-ss18-fonts
