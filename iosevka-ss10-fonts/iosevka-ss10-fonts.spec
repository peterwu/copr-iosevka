...
npm run build -- ttf::IosevkaSS10
npm run build -- ttf::IosevkaTermSS10
npm run build -- ttf::IosevkaFixedSS10
...
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaSS10/TTF/*.ttf      -t %{buildroot}%{_datadir}/fonts/iosevka-ss10-fonts
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaTermSS10/TTF/*.ttf  -t %{buildroot}%{_datadir}/fonts/iosevka-term-ss10-fonts
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaFixedSS10/TTF/*.ttf -t %{buildroot}%{_datadir}/fonts/iosevka-fixed-ss10-fonts
