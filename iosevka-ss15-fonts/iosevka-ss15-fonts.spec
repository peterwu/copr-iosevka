...
npm run build -- ttf::IosevkaSS15
npm run build -- ttf::IosevkaTermSS15
npm run build -- ttf::IosevkaFixedSS15
...
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaSS15/TTF/*.ttf      -t %{buildroot}%{_datadir}/fonts/iosevka-ss15-fonts
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaTermSS15/TTF/*.ttf  -t %{buildroot}%{_datadir}/fonts/iosevka-term-ss15-fonts
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaFixedSS15/TTF/*.ttf -t %{buildroot}%{_datadir}/fonts/iosevka-fixed-ss15-fonts
