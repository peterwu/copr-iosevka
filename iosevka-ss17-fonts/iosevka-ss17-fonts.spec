...
npm run build -- ttf::IosevkaSS17
npm run build -- ttf::IosevkaTermSS17
npm run build -- ttf::IosevkaFixedSS17
...
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaSS17/TTF/*.ttf      -t %{buildroot}%{_datadir}/fonts/iosevka-ss17-fonts
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaTermSS17/TTF/*.ttf  -t %{buildroot}%{_datadir}/fonts/iosevka-term-ss17-fonts
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaFixedSS17/TTF/*.ttf -t %{buildroot}%{_datadir}/fonts/iosevka-fixed-ss17-fonts
