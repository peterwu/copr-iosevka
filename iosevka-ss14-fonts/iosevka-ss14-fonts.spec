...
npm run build -- ttf::IosevkaTermSS14
npm run build -- ttf::IosevkaFixedSS14
...
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaSS14/TTF/*.ttf      -t %{buildroot}%{_datadir}/fonts/iosevka-ss14-fonts
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaTermSS14/TTF/*.ttf  -t %{buildroot}%{_datadir}/fonts/iosevka-term-ss14-fonts
%{__install} -D -m 0644 %{_builddir}/%{source_name}-%{version}/dist/IosevkaFixedSS14/TTF/*.ttf -t %{buildroot}%{_datadir}/fonts/iosevka-fixed-ss14-fonts
